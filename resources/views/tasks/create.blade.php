...
<body>
    ...
    <form id="taskForm" method="POST" action="{{ route('tasks.store') }}">
        ...
        <div class="input-group">
            ...
            <input type="text" id="title" name="title" maxlength="50" required autocomplete="off" oninput="updateCharCounter('title', 50)">
            <div class="char-counter" id="counter-title">0/50</div>
        </div>

        <div class="input-group">
            <label for="description">Descrição da Task</label>
            <textarea id="description" name="description" maxlength="500" autocomplete="off" oninput="updateCharCounter('description', 500)"></textarea>
    ...
    <script>
        ...
        // Initialize counters on page load (for persisted values)
        document.addEventListener('DOMContentLoaded', function() {
